...
public class CallersOf2 extends GhidraScript {
  @Override public void run() throws Exception {
    Program p = getCurrentProgram();
    FunctionManager fm = p.getFunctionManager();
    Listing li = p.getListing();
    ReferenceManager rm = p.getReferenceManager();
    Address target = p.parseAddress("0x1c5e98")[0]; // EVP_DecryptInit_ex PLT
    println("Searching callers of EVP_DecryptInit_ex @" + Long.toHexString(target.getOffset()));
