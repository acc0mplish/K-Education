...
var createPdfium = (() => {
  ...
  return (async function(moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      let dirname = require("url").pathToFileURL(__filename).href;
      if (dirname.startsWith("data:")) {
        dirname = "/";
      }
      var require$1 = createRequire(dirname);
    }
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      if (!require("url").pathToFileURL(__filename).href.startsWith("data:")) {
        scriptDirectory = nodePath.dirname(require$1("url").fileURLToPath(require("url").pathToFileURL(__filename).href)) + "/";
      }
      readBinary = (filename) => {
    ...
    function findWasmBinary() {
      ...
      if (ENVIRONMENT_IS_SHELL)
        return "pdfium.wasm";
      return new URL("pdfium.wasm", require("url").pathToFileURL(__filename).href).href;
    }
    var wasmBinaryFile;
