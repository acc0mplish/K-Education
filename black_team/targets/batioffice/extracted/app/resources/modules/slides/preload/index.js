...
const api = {
  ...
  consumeAiPrompt: () => electron.ipcRenderer.invoke("slides:consume-ai-prompt"),
  ...
  localGenStatus: () => electron.ipcRenderer.invoke("slides:local-gen-status"),
  ...
  visionAvailable: () => electron.ipcRenderer.invoke("ai:vision-available"),
