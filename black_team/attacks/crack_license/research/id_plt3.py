...
for i in range(shnum):
    ...
    secs[nm]=dict(off=u64(o+24),va=u64(o+16),size=u64(o+32),entsize=u64(o+56))
def sym_name(i):
...
for k in range(rp['size']//rp['entsize']):
    ...
    if (rinfo&0xffffffff)==7:
        symidx=(rinfo>>32)&0xffffffff; slot=(roff-gotva)//8
        stub2name[slot]=sym_name(symidx)
def identify(va):
    return stub2name.get((va-plt)//16,"?")
for tgt in [0xf710,0xf700,0xf740,0xf730,0xf750,0xf760,0x10940,0xf800,0xf9c0,0xf550]:
